...
def conversion(request):
    if request.method == 'POST':
        ...
        if request.POST['measurment'] == 'length':
            measurment_form=ConversioonLengthForm()
            context={
                'form':form,
        ...
        if request.POST['measurment'] == 'mass':
            measurment_form=ConversioonMassForm()
            context={
                'form':form,
                'm_form':measurment_form,
                'input':True
            ...
            if 'input' in request.POST:
                ...
                if input and int(input) >= 0:
                    if first == 'pound' and second == 'kilogram':
                        ...
                        answer=f'{input} kilogram= {int(input)*2.262} pound'
                        context={
                            'form':form,
                            'm_form':measurment_form,
                            'input':True,
...
def register(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            messages.success(request,f'Account Careated for{username}!!')
